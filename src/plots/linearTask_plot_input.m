...
hold on
plot( time, input(3,time),'Color', 'blue', 'LineWidth',1);     % arb1
plot( time, input(4,time),'Color', [ 68/255 158/255 1 ], 'LineWidth',1);     % arb2
plot( time, input(1,time), 'Color', 'green', 'LineWidth',2);     % cue 1
plot( time, input(2,time),'Color', 'red', 'LineWidth',2);          % cue 2
%plot( time , feedback_target(1,time),'Color', [ 1 , 123/255 , 0 ], 'LineWidth',2);
%plot( time , input(4,:),'Color', [ 1 , 123/255 , 0 ], 'LineWidth',2);
hold off
...
legend( 'u^{arb}_1', 'u^{arb}_2', 'u^+', 'u^-',   'Location', 'West');
