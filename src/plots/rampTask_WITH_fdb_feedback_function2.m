...
% --------------------- plot parameters ----------------------
figure(5)
set( 5, 'Position', [ scrsz(3)/5    170         scrsz(3)*0.55       300         ] );
...
% ======================== THINGS TO CHANGE ==============================
%title( '\bffeedback', 'fontsize', 12 );           % ------------ title 
...
axis( [ min( prediction_tf_tf( taskNr , time )  ) - margin      max( prediction_tf_tf( taskNr , time )  ) + margin     ...
        min( prediction_tf_tf( taskNr , time )  ) - margin      max( prediction_tf_tf( taskNr , time )  ) + margin] );
