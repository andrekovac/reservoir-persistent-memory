...
% plot( time , target_vl( taskNr , time ) , 'LineWidth', 2);
% hold on
% plot( time , prediction_vl( taskNr , time ), 'g' , 'LineWidth', 2);
% hold off


% ======================== THINGS TO CHANGE ==============================
title( '\bfExperiment 3 - increasing ramps - task 2', 'fontsize', 12 );           % ------------ title 
