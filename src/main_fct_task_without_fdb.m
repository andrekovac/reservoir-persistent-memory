...
global stdData;
% take simulation times from global variable
...
[ d.task.input                  ...
  ...
  d.MG.theta                      = stdData.params.theta;      % 0.7
...
%[ d.res.input_masks               ...
%  d.res.feedback_mask ]           = subsetMasks( [1 1 1], [ .1 .1 .1 ], 0, d.res.N_neurons );
%[ d.res.input_masks               ...
%  d.res.feedback_mask ]           = randomMasks( [1 1 1], [ .1 .1 .1 ], 0, d.res.N_neurons );
[ d.res.input_masks               ...
  d.res.feedback_mask ]           = fullMasks( [1 1 1], [ .1 .1 .1 ], 0, d.res.N_neurons );
