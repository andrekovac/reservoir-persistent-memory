...
d.task.offset_vl    = stdData.task.offset_vl;
  ...
  d.task.names = {'r3^3 / 10 + r4', 'r3 and 2 * r3', 'r3 + r4 and |r3 - r4|', 'r3 * r4', '|r3 - r4|'};
[ d.task.input                  ...
  d.task.feedback_targets       ... 
  d.task.readout_targets ]        = linear_nonLinearTask_rand( ...
...
%[ d.res.input_masks               ...
%  d.res.feedback_mask ]           = subsetMasks( [1 1 2 2 1], [ .1 .1 .1 .1 .1 ], 5, d.res.N_neurons );
%[ d.res.input_masks               ...
%  d.res.feedback_mask ]           = randomMasks( [1 1 2 2 1], [ .1 .1 .1 .1 .1 ], 5, d.res.N_neurons );
[ d.res.input_masks               ...
  d.res.feedback_mask ]           = fullMasks( [1 1 2 2 1], [ .1 .1 .1 .1 .1 ], 5, d.res.N_neurons );
